...
ffmpeg_bin=r"C:\\Users\\user\\AppData\\Local\\Microsoft\\WinGet\\Packages\\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\\ffmpeg-7.1-full_build\\bin\\ffmpeg.exe"
ffprobe_bin=r"C:\\Users\\user\\AppData\\Local\\Microsoft\\WinGet\\Packages\\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\\ffmpeg-7.1-full_build\\bin\\ffprobe.exe"
for binary in (ffmpeg_bin,ffprobe_bin):
    if os.path.isfile(binary): datas.append((binary,"."))
...
pyz=PYZ(a.pure)
exe=EXE(pyz,a.scripts,[],exclude_binaries=True,name="MusicWaveStudio_v0.8.3.5",debug=False,bootloader_ignore_signals=False,strip=False,upx=True,console=False,icon=None)
coll=COLLECT(exe,a.binaries,a.datas,strip=False,upx=True,name="MusicWaveStudio_v0.8.3.5")
