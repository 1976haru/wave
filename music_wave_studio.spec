...
pyz=PYZ(a.pure)
exe=EXE(pyz,a.scripts,[],exclude_binaries=True,name="MusicWaveStudio_v0.8.3.2",debug=False,bootloader_ignore_signals=False,strip=False,upx=True,console=False,icon=None)
coll=COLLECT(exe,a.binaries,a.datas,strip=False,upx=True,name="MusicWaveStudio_v0.8.3.2")
