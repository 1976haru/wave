...
class MainWindow(QMainWindow):
    ...
    def filter_templates(self,mode="전체 스타일"):
        ...
        for path,data in getattr(self,"template_entries",[]):
            ...
            if self.template_filter.currentIndex()==6 and category!="signature_dual": continue
            if self.template_filter.currentIndex()==7 and category!="signature_his": continue
            if self.template_filter.currentIndex()==8 and category!="signature_her": continue
