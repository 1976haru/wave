...
sheet.save("validation_results/v079_flagship_12.png")
for ident in ["18_tokyo_neon","23_chill_ribbon","38_spectrum_ring","40_radial_wave"]:
 t=load_template(Path("templates")/(ident+".json")); rgba=CPURenderer().render_rgba(960,540,{"values":vals},dict(t,_quality="QUALITY",_glow_scale=.5)); Image.fromarray(rgba,"RGBA").save(f"validation_results/v079_{ident}.png")
print("done")
